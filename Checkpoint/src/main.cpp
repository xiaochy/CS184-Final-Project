...
int main(int argc, char** argv)
{
    ...
    Bounds3 bbox(Vector3f(-1., 3, -7.), Vector3f(1., 0, 1.5));
    globalSPS = new SnowParticleSet();

    // TODO: add shapes and particles
    ...
    Vector3f center = (bbox.pMin + bbox.pMax)/2.0;
    float radius = 0.2;
    Sphere sphere(center,radius);
    globalSPS->addParticlesInAShape(&sphere, &m);
